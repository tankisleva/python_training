...
# # формируем json через стандартную библиотеку json
# with open(file, "w") as out:
#     out.write(json.dumps(test_data_five_group, default=lambda x: x.__dict__, indent=2))

# формируем json при помощи библиотеки jsonpickle
with open(file, "w") as out:
